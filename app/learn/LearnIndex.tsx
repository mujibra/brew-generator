...
export function LearnIndex() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-8">
      ...
      <h1 className="mt-4 text-3xl font-semibold tracking-tight">Learn</h1>
      <p className="mt-2 text-[var(--color-muted)]">
        {CARDS.length} cards on why coffee does what it does. Every one ends with what it changes
        about your brew.
      </p>
      ...
      <input
        ...
        className="mt-6 w-full rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] px-4"
      />
      ...
      <p className="mt-10 text-sm text-[var(--color-faint)]">
        This first set covers the mechanisms the dial-in assistant cites. Varieties, processing and
        origins are next.
      </p>
    </main>
  )
